...
void seleccion()
{
  switch (fila)
  {
    ...
    break;
    case 1: // Velocidad
      if (pulsador == true  and columna < 6) // columna es una variable que avanza en horizontal por la pantalla, cuando vale 0 podemos cambia en vertical con derecha o izquierda, cuando no aumentamos la variable con la que estemos trabajando
      {
        columna++;
      }
      else if (pulsador == true and columna == 6)
      {
        columna = 0;
      }
      switch (columna)
      {
        ...
        case 1:
          if (pulsador == true and Modo == 0)
          {
            ...
            if (v<vmax and derecha == true)
            {
              v++;
            }
            else if (v>vmin and izquierda == true)
            {
              v--;
            }
            if (v<10)
          ...
          case 2:
            ...
            else if (derecha == true and Modo == 1)
            {
              lcd.setCursor(0,2);
              lcd.write(byte(0));
              lcd.setCursor(0,3);
          ...
          case 6:
            ...
            else if (izquierda == true and Modo == 1)
            {
              lcd.setCursor(0,2);
              lcd.write(byte(0));
              lcd.setCursor(0,3);
